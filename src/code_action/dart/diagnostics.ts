...
function autoImport(){
	...
	if(text.includes("StatelessWidget")||text.includes('StatefulWidget')){
		if(text.includes("import 'package:flutter/material.dart';")||text.includes("import 'package:flutter/widgets.dart';")||text.includes("import 'package:flutter/cupertino.dart';"))return
